...
$userEmail=$_SESSION['login'];
  $sql ="SELECT password FROM user WHERE userEmail=:userEmail and password=:password";
...
if($query -> rowCount() > 0)
{
$con="update user set password=:newpassword where userEmail=:userEmail";
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample"  method="post" onSubmit="return valid();" name="chngpwd">
                      ...
                      <button type="submit" class="btn btn-primary mr-2" name="change">Change</button>

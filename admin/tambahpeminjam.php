...
$note=$_POST['note'];
$isissued=1;
$sql="INSERT INTO tblissuedbook(noic,bookid,note) VALUES(:noic,:bookid,:note);
          ...
          <div class="card">
            ...
            <div class="row">
                    ...
                    <label for="exampleInputName1">IC Number</label>    
                        <input type="text" name="noic" id="noic" onBlur="getuser()" style="font-weight:bold;" class="form-control" required autocomplete="off">
                      </div>
                    </div>
...
<div class="row">
                    <div class="form-group col-md-6"> 
                    <label for="exampleInputName1">ISBN or Book Title</label>   
                        <input type="text" name="bookid" id="bookid" onBlur="getbook()" style="font-weight:bold;" class="form-control" required autocomplete="off">
                      </div>
                    </div>
                    <div class="form-group">
<span id="get_book_name" style="font-size:16px;"></span> 
                  ...
                  <div class="row">
                    ...
                    <label for="exampleInputName1">Note (Pre-returning date)</label>    
                        <input type="date" name="note" style="font-weight:bold;" class="form-control" required>
                      </div>
                    </div>

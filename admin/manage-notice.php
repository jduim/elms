...
header('location:index.php');
    ...
    if(isset($_GET['delnid']))
    {
    $nid=intval($_GET['delnid']);
    $sql="delete from tblnotice where id=:nid";
    $query=$dbh->prepare($sql);
    $query->bindParam(':nid',$nid,PDO::PARAM_STR);
    $query->execute();
     echo "<script>alert('Notice has been removed');</script>"; 
...
<head>
  ...
  <title>ELMS | Manage Notice</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Manage Notices</h1><br><!--a href="#" onclick="printDiv()"><i class="nav-icon fas fa-print"></i></a-->
          </div>
          <div class="col-sm-6">
...
<td>
<a href="manage-notice.php?delnid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Do you really want to delete the notice?');">
